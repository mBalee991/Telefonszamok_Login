...
namespace TelefonszamContext
{

    public partial class cnTelefonszam : DbContext
    {

        public cnTelefonszam() :
            base()
        {
            OnCreated();
        }

        public cnTelefonszam(DbContextOptions<cnTelefonszam> options) :
            base(options)
        {
            OnCreated();
        }
        ...
        private void enTelefonszamMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<enTelefonszam>().Property(x => x.Szam).HasColumnName(@"Szam").IsRequired().ValueGeneratedNever().HasMaxLength(25);
        ...
        private void enHelysegMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<enHelyseg>().Property(x => x.IRSZ).HasColumnName(@"IRSZ").IsRequired().ValueGeneratedNever().HasMaxLength(25);
            modelBuilder.Entity<enHelyseg>().Property(x => x.Nev).HasColumnName(@"Nev").IsRequired().ValueGeneratedNever();
